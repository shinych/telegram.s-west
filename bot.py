...
async def cmd_about(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "2️⃣ Каждый день в 12:00 бот запускает голосование из накопившихся предложений. "
        "Демократия в действии, да.\n\n"
        "3️⃣ В пятницу в 15:00 — чемпионат: топ-5 названий по итогам "
        "ежедневных голосований сражаются в финале. 🏆\n\n"
        "4️⃣ В 21:00 того же дня бот раскрывает авторов. "
